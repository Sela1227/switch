...
| V1.13.3 | 2026-04-18 | 卡片完整邊框 + 名稱/平台/好玩度顯示 |
| V1.13.3 | 2026-04-18 | 詳情可編輯名稱/平台/類別中文；卡片增加微格(5欄) |
| V1.13.3 | 2026-04-18 | 格數 4/6/8/12；卡片緊湊；UI 字體加大 |
| V1.13.3 | 2026-04-18 | 平台篩選依 ownedPlatform；卡牌風格設計 |
| V1.13.3 | 2026-04-18 | 搜尋列表緊湊化；版本選擇平台色；編號badge重設計 |
| V1.13.3 | 2026-04-18 | 詳情modal緊湊化；編號badge更明顯 |
| V1.13.3 | 2026-04-18 | 編號右下角更明顯；按鈕重組成一列 |
| V1.13.3 | 2026-04-18 | GameCard 重設計，封面乾淨，資訊區獨立不重疊 |
| V1.13.3 | 2026-04-18 | Modal置中；借出紀錄展開/刪除；手動新增+封面上傳 |
| V1.13.3 | 2026-04-18 | 修復 Railway 啟動失敗；DB路徑自動 fallback |
| V1.13.3 | 2026-04-18 | 編號移左上有框；好玩度移右上透明框 |
| V1.13.3 | 2026-04-18 | 手機UI重整；編號藍底白框正方形 |
| V1.13.3 | 2026-04-18 | Header不換行；編號真正方形；資訊區比例縮放 |
| V1.13.3 | 2026-04-18 | 遊戲詳情可更換封面（搜尋或上傳）|
| V1.13.3 | 2026-04-18 | SELA logo；更名；欄數6/9/12；換封面獨立modal |
| V1.13.3 | 2026-04-18 | 手機大/中/小=2/4/6欄，桌機=6/9/12欄 |
| V1.13.3 | 2026-04-18 | 多用戶架構；探索頁籤；跨用戶借用申請；公開/私人設定 |
| V1.13.3 | 2026-04-18 | 共用遊戲目錄；搜尋優先顯示收藏庫；一鍵導入 |
| V1.13.3 | 2026-04-18 | 目錄導入允許重複(confirm)；每份獨立可自訂封面 |
| V1.13.3 | 2026-04-18 | 社群封面庫；上傳可分享；換封面 tab 切換 |
| V1.13.3 | 2026-04-18 | 加入收藏時自動翻譯為繁中遊戲名稱 |
| V1.13.3 | 2026-04-18 | 加入收藏優先查任天堂台灣官方中文名，再 Claude 翻譯 |
| V1.13.3 | 2026-04-18 | 任天堂台灣官方名查詢改用Claude知識庫；第三方遊戲Claude通用翻譯 |
| V1.13.3 | 2026-04-18 | 巴哈商城爬蟲+名稱庫；翻譯三段退回；設定頁可觸發 |
| V1.13.3 | 2026-04-18 | 爬蟲策略改強健版+debug endpoint；換封面加URL輸入 |
| V1.13.3 | 2026-04-18 | 即時搜尋巴哈商城取中文名+封面；封面URL規律解析 |
| V1.13.3 | 2026-04-18 | 設定頁新增巴哈搜尋測試，即時看封面有沒有抓到 |
| V1.13.3 | 2026-04-18 | 改搜 acg.gamer.com.tw；試 PNG/JPG；修中文 URL 編碼 |
| V1.13.3 | 2026-04-18 | 卡片封面改 contain+150%，巴哈圖片不再裁切 |
| V1.13.3 | 2026-04-18 | 巴哈封面優先；清理[Switch]前綴 |
