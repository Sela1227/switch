...
| V1.10.5 | 2026-04-18 | 卡片完整邊框 + 名稱/平台/好玩度顯示 |
| V1.10.5 | 2026-04-18 | 詳情可編輯名稱/平台/類別中文；卡片增加微格(5欄) |
| V1.10.5 | 2026-04-18 | 格數 4/6/8/12；卡片緊湊；UI 字體加大 |
| V1.10.5 | 2026-04-18 | 平台篩選依 ownedPlatform；卡牌風格設計 |
| V1.10.5 | 2026-04-18 | 搜尋列表緊湊化；版本選擇平台色；編號badge重設計 |
| V1.10.5 | 2026-04-18 | 詳情modal緊湊化；編號badge更明顯 |
| V1.10.5 | 2026-04-18 | 編號右下角更明顯；按鈕重組成一列 |
| V1.10.5 | 2026-04-18 | GameCard 重設計，封面乾淨，資訊區獨立不重疊 |
| V1.10.5 | 2026-04-18 | Modal置中；借出紀錄展開/刪除；手動新增+封面上傳 |
| V1.10.5 | 2026-04-18 | 修復 Railway 啟動失敗；DB路徑自動 fallback |
| V1.10.5 | 2026-04-18 | 編號移左上有框；好玩度移右上透明框 |
| V1.10.5 | 2026-04-18 | 手機UI重整；編號藍底白框正方形 |
| V1.10.5 | 2026-04-18 | Header不換行；編號真正方形；資訊區比例縮放 |
