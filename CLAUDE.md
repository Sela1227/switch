...
| V1.9.6 | 2026-04-18 | 卡片完整邊框 + 名稱/平台/好玩度顯示 |
| V1.9.6 | 2026-04-18 | 詳情可編輯名稱/平台/類別中文；卡片增加微格(5欄) |
| V1.9.6 | 2026-04-18 | 格數 4/6/8/12；卡片緊湊；UI 字體加大 |
| V1.9.6 | 2026-04-18 | 平台篩選依 ownedPlatform；卡牌風格設計 |
| V1.9.6 | 2026-04-18 | 搜尋列表緊湊化；版本選擇平台色；編號badge重設計 |
| V1.9.6 | 2026-04-18 | 詳情modal緊湊化；編號badge更明顯 |
| V1.9.6 | 2026-04-18 | 編號右下角更明顯；按鈕重組成一列 |
| V1.9.6 | 2026-04-18 | GameCard 重設計，封面乾淨，資訊區獨立不重疊 |
